...
public partial class ManageUser : System.Web.UI.Page
{
    ...
    void BindMyGrid()
    {
            ...
            QRY += "IsAdmin = 'TRUE' OR U_isact = 'TRUE' AND U_id>0";
            QRY += "ORDER BY U_id";
    ...
    protected void dtGrd_acc_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        QRY = "UPDATE tbl_User SET U_isact = 'FALSE' , IsAdmin = 'FALSE' WHERE U_id=" + dtGrd_acc.Rows[e.RowIndex].Cells[0].Text.ToString();
        CNN = new SqlConnection(cnStr);
        CMD = new SqlCommand(QRY, CNN);
        CNN.Open();
        CMD.ExecuteNonQuery();
